...
/* __string_template__7aba95001af37253d0d66afc3858731b */
class __TwigTemplate_f9b3005e04b8fc3b55782d8f627d04db extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 2
        yield from $this->load("__string_template__7aba95001af37253d0d66afc3858731b", 2, "1319643574")->unwrap()->yield($context);
        yield from [];
    }
    ...
    {
        return "__string_template__7aba95001af37253d0d66afc3858731b";
    }
    ...
    {
        return new Source("", "__string_template__7aba95001af37253d0d66afc3858731b", "");
    }
...
/* __string_template__7aba95001af37253d0d66afc3858731b */
class __TwigTemplate_f9b3005e04b8fc3b55782d8f627d04db___1319643574 extends Template
{
    private Source $source;
    /**
     * @var array<string, Template>
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            ...
            'promo' => [$this, 'block_promo'],
            'links' => [$this, 'block_links'],
            'utility_links' => [$this, 'block_utility_links'],
        ];
        $this->sandbox = $this->extensions[SandboxExtension::class];
        $this->checkSecurity();
    }
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->load("uk_components:apple-global-nav", 2);
        yield from $this->parent->unwrap()->yield($context, array_merge($this->blocks, $blocks));
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["logo", "promo", "links", "utility_links"]);    }
  ...
  ";
     ...
     * @return iterable<null|scalar|\Stringable>
     */
    public function block_promo(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 7
        yield "    ";
  ...
  ";
     ...
     * @return iterable<null|scalar|\Stringable>
     */
    public function block_utility_links(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 13
        yield "    ";
