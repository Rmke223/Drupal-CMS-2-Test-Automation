...
class __TwigTemplate_d1f7df10c98ed348d321795cf4b5f92d extends Template
{
...
";
        ...
        if ((($tmp = ($context["breadcrumb"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 12
            yield "  ";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(Twig\Extension\CoreExtension::include($this->env, $context, "@mercury/components/breadcrumb/breadcrumb.twig"));
            yield "
";
        }
    ...
    {
        return array (  50 => 12,  48 => 11,  44 => 10,);
    }
    ...
    public function checkSecurity()
    {
        ...
        static $functions = ["attach_library" => 10, "include" => 12];
